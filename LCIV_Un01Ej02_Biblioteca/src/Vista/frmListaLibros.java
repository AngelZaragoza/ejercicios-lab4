...
public class frmListaLibros extends javax.swing.JFrame {
    ...
    private void cargarTabla() {
        ArrayList<DTO.DTOListaLibros> lista = gestor.listaLibrosConAutores();
        DefaultTableModel modelo = new DefaultTableModel();
        modelo.setColumnIdentifiers(new Object [] {"Descripción / Título del Libro",
                                                    "Nombre del Autor",
                                                    "Nacionalidad"});
        for (DTOListaLibros libro : lista) {
            modelo.addRow(new Object[] {libro.getNombreLibro(),libro.getNombreAutor(),
                                        libro.getNacionalidadAutor()});
        }
    }
